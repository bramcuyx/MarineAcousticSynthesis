...
TODO: When the source folders containing the background and event audio files are provided, there should also be a source folder containing the masks
        these masks should be generated by the user are in the shape of binary matrices based on a spectrogram of settings: nperseg=256, noverlap=128, nfft=256
        for every generated audiofile, the masks are agregated to get a final mask for the audio file
"""
import os
import random
import numpy as np
